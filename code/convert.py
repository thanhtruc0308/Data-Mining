...
fileToRead = "preprocessed.csv"  #csv file name or absolute path to be open.
fileToWrite = "preprocessed.arff" #name as how you'll save your arff file.
relation = "E-commerce" #how you'll like to call your relation as.
